...
public interface InteractionsListener
{
    ...
    default InteractionResponse onModalSubmit(Interaction interaction) { return new DeferredCallback(false); }
    
    default InteractionResponse onUnknownInteraction(Interaction interaction) { return new PongCallback();  }
}
